...
def get_args(description='Retrieval'):
    ...
    parser.add_argument("--init_model", default="ckpts/ckpt_msrvtt_retrieval_looseType/pytorch_model.bin.3", type=str, required=False, help="Initial model.")
    parser.add_argument("--resume_model", default="ckpts/ckpt_msrvtt_retrieval_looseType/pytorch_opt.bin.3", type=str, required=False, help="opt模型Resume train model.")
    ...
    parser.add_argument("--local_rank", type=int, help="distribted training") #default=
    ...
    parser.add_argument('--text_num_hidden_layers', type=int, default=8, help="Layer NO. of text.")
